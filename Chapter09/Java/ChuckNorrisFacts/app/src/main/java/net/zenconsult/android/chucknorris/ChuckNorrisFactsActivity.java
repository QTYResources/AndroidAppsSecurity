...
public class ChuckNorrisFactsActivity extends AppCompatActivity implements CommsEvent {

    private static final String TAG = ChuckNorrisFactsActivity.class.getSimpleName();
